...
const categories = [
  {
    ...
    image: '/filteredphotos/man-white-shirt-studio-portrait-photography-vancouver.webp',
    alt: 'Man in white shirt seated for studio portrait session - Njagih Studios Vancouver photography portfolio',
    href: '/portfolio',
    isPage: true,
    arrow: '→',
  },
  {
    title: 'Instagram',
    image: '/filteredphotos/boy-kicking-soccer-ball-action-sports-photography.webp',
    alt: 'Boy kicking soccer ball on grass field during youth match - Follow Njagih Studios on Instagram',
  ...
  {
    title: 'Services',
    image: '/filteredphotos/woman-battle-ropes-workout-gym-fitness-photography.webp',
    alt: 'Woman training with battle ropes during gym workout - Njagih Studios professional photography services',
    href: '/services',
    isPage: true,
    arrow: '→',
  },
  {
    title: 'Get in Touch',
    image: '/filteredphotos/woman-speaker-stage-event-photography-vancouver.webp',
    alt: 'Woman speaking on stage at Vancouver conference event - Contact Njagih Studios Vancouver photographer',
    href: '#contact',
    arrow: '→',
  },
];
